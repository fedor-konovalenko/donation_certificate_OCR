...
4. [img2table](https://github.com/xavctn/img2table/tree/main). Плохо работает "из коробки", зато хорошо ищет ячейки таблиц. Для этого его и буду использовать, а далее распознавать в пределах отдельно взятой ячейки
