...
- **rotation.ipynb - ноутбук с экспериментами по определению ориентации изображения** 
...
<img src="https://github.com/fedor-konovalenko/donation_certificate_OCR/blob/master/img/cont.png" width="500" height="500">

*Пример контуров таблицы на "правильной" справке"*
...
____________
## Update 09.12.2023
Возникла задача определения ориентации картинки при загрузке. 
Добавлен ноутбук с реализацией с помощью pytesseract.
Так себе вариант, поскольку чувствителен к разрешению картинки и количеству символов на изображении

**Результаты на тестовой выборке**

<img src="https://github.com/fedor-konovalenko/donation_certificate_OCR/blob/master/img/pic3.png" width="500" height="500">
